<template>
    <div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400" v-if="isView">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all m-10 align-middle"
                        ...
                        <fieldset style="margin-top: 0px;">
                            ...
                            <div class="grid grid-cols-12 grid-flow-row gap-4 mx-2">
                                <div>
                                    ...
                                    <select id="formPatientPrefix" v-model="form.prefix"
                                        :disabled=isView
                                ...
                                <div>
                                    ...
                                    <select id="formPatientSuffix" v-model="form.suffix"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientSex-male" value="Male" v-model="form.sex" :disabled=isView>
                                    <label for="formPatientSex-male" class="ml-1 mr-4">Male</label>
                                    <input type="radio" id="formPatientSex-female" value="Female" v-model="form.sex" :disabled=isView>
                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-12 grid-flow-row gap-4 mx-2">
                                <div class="col-span-2">
                                    ...
                                    <Datepicker
                                        v-model="form.birth_date" :enable-time-picker="false"
                                        model-type="yyyy-MM-dd" :is-24="false" :disabled=isView>
                                    </Datepicker>
                                </div>
                                <div class="col-span-2">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientCivilStatus"
                                        v-model="form.civil_status" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.maiden_last_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.maiden_middle_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientEducationalAttainment"
                                        v-model="form.educational_attainment" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientEmploymentStatus"
                                        v-model="form.employment_status" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientNationality"
                                        v-model="form.nationality" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.tax_identification"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientReligion"
                                        v-model="form.religion" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientEthnicGroup"
                                        v-model="form.ethnic_group" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientIndigenous-yes" value="Yes" v-model="form.indigenous" :disabled=isView>
                                    <label for="formPatientIndigenous-yes" class="ml-1 mr-4">Yes</label>
                                    <input type="radio" id="formPatientIndigenous-no" value="No" v-model="form.indigenous" :disabled=isView>
                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-12 grid-flow-row gap-4 mx-2">
                                <div class="col-span-3">
                                    ...
                                    <input type="text" v-model="form.number_street_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-3">
                                    ...
                                    <select id="formPatientBarangay"
                                        v-model="form.barangay" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.landline"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div>
                                    ...
                                    <select id="formPatientBloodType"
                                        v-model="form.blood_type" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.mother_last_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.mother_first_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.mother_middle_name"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Datepicker
                                        v-model="form.mother_birth_date" :enable-time-picker="false"
                                        model-type="yyyy-MM-dd" :is-24="false" :disabled=isView>
                                    </Datepicker>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="grid grid-cols-12 grid-flow-row gap-4 mx-2">
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientDSWD-yes" value="Yes" v-model="form.dsdw_member" :disabled=isView>
                                    <label for="formPatientDSWD-yes" class="ml-1 mr-4">Yes</label>
                                    <input type="radio" id="formPatientDSDW-no" value="No" v-model="form.dsdw_member" :disabled=isView>
                                ...
                                <div class="col-span-2">
                                    <label for="formPatientfacility_household_no"
                                        ...
                                        Number:</label>
                                    <input type="text"
                                        v-model="form.facility_household_no" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.household_no"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientpantawid_member-yes" value="Yes" v-model="form.pantawid_member" :disabled=isView>
                                    <label for="formPatientpantawid_member-yes" class="ml-1 mr-4">Yes</label>
                                    <input type="radio" id="formPatientpantawid_member-no" value="No" v-model="form.pantawid_member" :disabled=isView>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.pantawid_member_no"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.family_serial_no"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientphilhealth_member-yes" value="Yes" v-model="form.philhealth_member" :disabled=isView>
                                    <label for="formPatientphilhealth_member-yes" class="ml-1 mr-4">Yes</label>
                                    <input type="radio" id="formPatientDSDW-no" value="No" v-model="form.philhealth_member" :disabled=isView>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientphilhealth_status-Active" value="Active" v-model="form.philhealth_status" :disabled=isView>
                                    <label for="formPatientphilhealth_status-Active" class="ml-1 mr-4">Active</label>
                                    <input type="radio" id="formPatientDSDW-Inactive" value="Inactive" v-model="form.philhealth_status" :disabled=isView>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" v-model="form.philhealth_no"
                                        :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="formPatientphilhealth_category"
                                        v-model="form.philhealth_category" :disabled=isView
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="radio" id="formPatientpcb_member-yes" value="Yes" v-model="form.pcb_member" :disabled=isView>
                                    <label for="formPatientpcb_member-yes" class="ml-1 mr-4">Yes</label>
                                    <input type="radio" id="formPatientDSDW-no" value="No" v-model="form.pcb_member" :disabled=isView>
